    ...
    <a href="" class="logo"><img src="images/logo.png" style="background-color:dimgray; border-radius: 5px; width: 250px; height:250px; border-radius: 200px;"></a>
        <div class="login1">
            <div class="login1a">
                ...
                <br>
                <button type="submit" style="width:260px; height:30px; background-color:sienna; border-radius: 5px; font-size: 20px">Đăng ký</button>
                <p> Chào mừng bạn đến với Good Food</p>
